...
export function AppShell({
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-4 pb-10 pt-6 sm:px-6">
      <header className="mb-8 flex flex-col gap-5 rounded-[32px] border border-border bg-panel/70 p-4 shadow-calm backdrop-blur sm:flex-row sm:items-center sm:justify-between">
        <div>
